...
static offsets_t *offsets[] =
{
    ...
    &(offsets_t)
    {
        ...
        .funcs =
        {
            .copyin = 0xfffffff0071f76dc,
            .copyout = 0xfffffff0071f7c5c,
            .kalloc_external = 0xfffffff00711a5dc,
            .csblob_get_cdhash = 0xfffffff007436664,
        },
        .data = 
        {
            .zonemap = 0xfffffff007664ec8,
            .realhost = 0xfffffff007647bb8,
        },
        .struct_offsets =
        {
            .proc_pid = 0x60,
    ...
    &(offsets_t)
    {
        ...
        .funcs =
        {
            .copyin = 0xfffffff007180e98,
            .copyout = 0xfffffff00718108c,
            .kalloc_external = 0xfffffff0070b038c,
            .csblob_get_cdhash = 0xfffffff00736a070,
        },
        .data = 
        {
            .zonemap = 0xfffffff00754c478,
            .realhost = 0xfffffff00752eba0,
        },
        .struct_offsets =
        {
            .proc_pid = 0x10,
